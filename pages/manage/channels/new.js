...
function NewChannel({ query, session }) {
  ...
  const formSubmitFunc = (values) => {
    fetch(`${process.env.NEXT_PUBLIC_NEXTAUTH_URL}/api/admin/channels/new`, {
      method: "POST",
      headers: {
        ...
        <Container maxWidth="none" className={classes.container}>
          <Protected>
            <>
              ...
              <ChannelEditor formSubmitFunc={formSubmitFunc} />
            </>
          </Protected>
        </Container>
      </Layout>
